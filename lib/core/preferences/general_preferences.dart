...
abstract class Preferences {
  ...
  /// When enabled, the app hides from the Dock and only shows in the status bar (menu bar).
  /// The app window is not shown on launch; only the tray icon appears.
  /// This is useful for auto-start scenarios where the user wants the VPN to run silently.
  static final hideFromDock = PreferencesNotifier.create<bool, bool>("hide_from_dock", false);
