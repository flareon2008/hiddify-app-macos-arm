            ...
            if (PlatformUtils.isMacOS)
              SwitchListTile.adaptive(
                ...
                onChanged: (value) async {
                  ...
                  // Immediately apply dock visibility change on macOS
                  try {
                    await _dockVisibilityChannel.invokeMethod('setDockVisibility', {'visible': !value});
                  } catch (e) {
                    // Method channel may not be available yet
                    debugPrint('Failed to set dock visibility: $e');
                  }
                },
              ),
          ],
